...
export interface EditorPluginApi {
     ...
     * Editor event bus.
     *
     * Plugins may use this bus to listen to editor events
     * without accessing editor internals directly.
     *
     * Common use cases:
     *
     ...
     * - build integrations such as autosave, analytics or media tracking
     */
    readonly events: EditorEventBus<EditorEventMap>;
